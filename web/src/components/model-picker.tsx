...
function resolveModelIcon(model: string) {
    ...
    if (name.includes("claude") || name.includes("anthropic")) return asset("icons/claude.svg");
    if (name.includes("gemini") || name.includes("google")) return asset("icons/gemini.svg");
    if (name.includes("gpt") || name.includes("openai")) return asset("icons/openai.svg");
    if (name.includes("grok") || name.includes("grok")) return asset("icons/grok.svg");
    if (name.includes("deepseek") || name.includes("deepseek")) return asset("icons/deepseek.svg");
    if (name.includes("glm") || name.includes("glm")) return asset("icons/glm.svg");
    return "";
}
